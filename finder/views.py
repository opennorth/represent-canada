...
def index(request):
  ...
  populations = {
    ...
    'Kawartha Lakes City Council'                  : 73214,
    'Kingston City Council'                        : 123363,
