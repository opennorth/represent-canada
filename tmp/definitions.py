...
# PROVINCES
    ...
    'Manitoba Electoral Districts': {
        ...
        'kind_first': False,
        'ider': utils.index_namer('mb'),
        'namer': utils.simple_namer(['ED']),
        'authority': '',
        'domain': 'Manitoba',
        'last_updated': date(2009, 8, 4),
        'href': 'https://mli2.gov.mb.ca//adminbnd/index.html',
        'notes': "The shapefile has 54 features instead of 57. Instead, we are using a shapefile received via email.",
        'encoding': 'iso-8859-1',
        'srid': '',
    ...
    'New Brunswick Electoral Districts': {
        ...
        'kind_first': False,
        'ider': utils.simple_namer(['SOURCE_ID']),
        'namer': utils.simple_namer(['NAME_EN']),
